...
class EntityTypeSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('entity_types')->insert([
            ['name' => 'Business Group', 'code' => 'BUSINESS_GROUP', 'level' => 1, 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Organization', 'code' => 'ORG', 'level' => 2, 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Branch', 'code' => 'BRANCH', 'level' => 3, 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Shop', 'code' => 'SHOP', 'level' => 4, 'created_at' => now(), 'updated_at' => now()],
            ['name' => 'Outlet', 'code' => 'OUTLET', 'level' => 5, 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('warehouse_types')->insert([
            ...
            ['name' => 'Wastage item', 'code' => 'WAST', 'state' => 'active', 'status' => 'approved', 'created_at' => now(), 'updated_at' => now()],
